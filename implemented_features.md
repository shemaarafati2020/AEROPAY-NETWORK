...
* **Transaction Friction**: Users must explicitly verify their identity via hardware biometrics (or device PIN fallback) *before* any money movement is processed, ensuring the physical slide-to-confirm is backed by cryptographic user intent.
